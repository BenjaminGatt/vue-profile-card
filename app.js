...
document.querySelector("#to-back").addEventListener("click", () => {
  document.querySelector("#profile-card").classList.add("profile-card-flipped");
});

document.querySelector("#to-front").addEventListener("click", () => {
  document
    .querySelector("#profile-card")
    .classList.remove("profile-card-flipped");
});

document.querySelector("#follow-button").addEventListener("click", () => {
  document.querySelector("#follow-button").classList.add("hidden");
  document.querySelector("#following-button").classList.remove("hidden");
});

document.querySelector("#following-button").addEventListener("click", () => {
  document.querySelector("#following-button").classList.add("hidden");
